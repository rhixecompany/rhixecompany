  ...
  $.fn.galleriffic = function (settings) {
    ...
    $.extend(this, {
      ...
      gotoImage: function (imageData) {
        ...
        if (this.currentImage && this.currentImage.index == index) return this;

        if (this.onSlideChange && this.currentImage) this.onSlideChange(this.currentImage.index, index);
      ...
      buildImage: function (imageData, isSync) {
        ...
        var newSlide = this.$imageContainer
          .append(
            '<span class="image-wrapper current"><a class="advance-link" rel="history" href="#' +
    ...
    if (this.enableHistory && !$.history) this.enableHistory = false;
    ...
    if (this.ssControlsContainerSel) {
      ...
      if (this.autoStart) {
        this.$ssControlsContainer.append(
      ...
      this.$ssControlsContainer.find("div.ss-controls a").click(function (e) {
