    ...
    d = {
      ...
      augmentObject: function (a, b) {
        ...
        var d = arguments,
          e,
          i = d[2];
        if (i && !0 !== i) for (e = 2; e < d.length; e += 1) a[d[e]] = b[d[e]];
        else {
      ...
      dump: function (a, b) {
        var d,
          ...
          i = [];
        if (c.isObject(a)) {
          if (a instanceof Date || ("nodeType" in a && "tagName" in a)) return a;
        ...
        if (c.isArray(a)) {
          ...
          i.push("{");
          for (d in a)
            c.hasOwnProperty(a, d) &&
              (i.push(d + " => "),
              c.isObject(a[d]) ? i.push(0 < b ? c.dump(a[d], b - 1) : "{...}") : i.push(a[d]),
              i.push(", "));
          1 < i.length && i.pop();
          i.push("}");
        }
      ...
      substitute: function (a, b, d) {
        for (var h, i, j, k, l, m = [], n; ;) {
          ...
          c.isObject(j)
            ? c.isArray(j)
              ? (j = c.dump(j, parseInt(l, 10)))
              : ((l = l || ""),
                (k = l.indexOf("dump")),
                -1 < k && (l = l.substring(4)),
                (j = j.toString === e.toString || -1 < k ? c.dump(j, parseInt(l, 10)) : j.toString()))
            : !c.isString(j) && !c.isNumber(j) && ((j = "~-" + m.length + "-~"), (m[m.length] = n));
          a = a.substring(0, h) + j + a.substring(i + 1);
        }
  ...
  c.Dom = {
    ...
    _getStyle: (function () {
      if (window.getComputedStyle)
        return function (a, b) {
          var b = "float" === b ? (b = "cssFloat") : c.Dom._toCamel(b),
            d = a.style[b],
            f;
        ...
        ? function (a, b) {
            ...
            if (a)
              switch (d) {
                case "opacity":
                  if (
                    e.isString(a.style.filter) &&
                    ((a.style.filter = "alpha(opacity=" + 100 * f + ")"), !a.currentStyle || !a.currentStyle.hasLayout)
                  )
                    a.style.zoom = 1;
                  break;
                case "float":
    ...
    _canPosition: function (a) {
      return "none" !== c.Dom._getStyle(a, "display") && c.Dom._inDoc(a);
    },
    _getXY: (function () {
      return i.documentElement.getBoundingClientRect
        ? function (a) {
            var d,
              f,
              e,
            ...
            if (c.Dom._canPosition(a)) {
              ...
              n &&
                ...
                ((j = g = 2),
                (h = e.compatMode),
                (m = o(e.documentElement, "borderLeftWidth")),
                (e = o(e.documentElement, "borderTopWidth")),
                6 === b.ie && "BackCompat" !== h && (j = g = 0),
                "BackCompat" == h && ("medium" !== m && (g = parseInt(m, 10)), "medium" !== e && (j = parseInt(e, 10))),
                (f[0] -= g),
                (f[1] -= j));
              if (d || a) ((f[0] += a), (f[1] += d));
              f[0] = k(f[0]);
              ...
              if ("fixed" !== c.Dom._getStyle(a, "position")) {
                for (j = a; (j = j.parentNode) && j.tagName;)
                  if (
                    ((a = j.scrollTop),
                    (e = j.scrollLeft),
                    m && "visible" !== c.Dom._getStyle(j, "overflow") && (g = c.Dom._calcBorders(j, g)),
                    a || e)
                  )
                    ((g[0] -= e), (g[1] -= a));
                g[0] += d;
                g[1] += f;
              } else if (k) ((g[0] -= d), (g[1] -= f));
              else if (l || m) ((g[0] += d), (g[1] += f));
              g[0] = Math.floor(g[0]);
              g[1] = Math.floor(g[1]);
            }
            return g;
    ...
    _setXY: function (a, b) {
      var d = c.Dom._getStyle(a, "position"),
        ...
        e = b.pos,
        g = b.noRetry,
        j = [parseInt(c.Dom.getComputedStyle(a, "left"), 10), parseInt(c.Dom.getComputedStyle(a, "top"), 10)],
        h;
      ...
      g ||
        ...
        ((null !== e[0] && d[0] != e[0]) || (null !== e[1] && d[1] != e[1])) &&
          c.Dom._setXY(a, { pos: e, noRetry: !0 }));
    },
    setX: function (a, b) {
    ...
    getElementsByClassName: function (a, b, d, f, g, j) {
      ...
      d = d ? c.Dom.get(d) : i;
      if (!d) return [];
      for (var h = [], b = d.getElementsByTagName(b), d = c.Dom.hasClass, m = 0, k = b.length; m < k; ++m)
    ...
    _hasClass: function (a, b) {
      ...
      a &&
        b &&
        ((d = c.Dom.getAttribute(a, "className") || ""),
        (d = b.exec ? b.test(d) : b && -1 < (" " + d + " ").indexOf(" " + b + " ")));
      return d;
    },
    ...
    _addClass: function (a, b) {
      ...
      a &&
        b &&
        ((e = c.Dom.getAttribute(a, "className") || ""),
        c.Dom._hasClass(a, b) || (c.Dom.setAttribute(a, "className", d(e + " " + b)), (f = !0)));
      return f;
    },
    ...
    _removeClass: function (a, b) {
      ...
      a &&
        b &&
        ((e = c.Dom.getAttribute(a, "className") || ""),
        c.Dom.setAttribute(a, "className", e.replace(c.Dom._getClassRegex(b), "")),
        (g = c.Dom.getAttribute(a, "className")),
        e !== g &&
          (c.Dom.setAttribute(a, "className", d(g)),
          (f = !0),
          "" === c.Dom.getAttribute(a, "className") &&
            ((e = a.hasAttribute && a.hasAttribute("class") ? "class" : "className"), a.removeAttribute(e))));
      return f;
    },
      ...
      a &&
        ...
        (e = b.to)
          ? f
            ? f !== e &&
              ((g = c.Dom.getAttribute(a, "className") || ""),
              (f = (" " + g.replace(c.Dom._getClassRegex(f), " " + e)).split(c.Dom._getClassRegex(e))),
              f.splice(1, 0, " " + e),
              c.Dom.setAttribute(a, "className", d(f.join(""))),
              (g = !0))
            : (g = c.Dom._addClass(a, b.to))
          : (g = !1));
      return g;
    },
    ...
    isAncestor: function (a, b) {
      ...
      a &&
        ...
        (a.contains && a !== b
          ? (d = a.contains(b))
          : a.compareDocumentPosition && (d = !!(a.compareDocumentPosition(b) & 16)));
      return d;
    },
    ...
    batch: function (a, b, d, f) {
      ...
      if ((a = a && (a.tagName || a.item) ? a : c.Dom.get(a)) && b) {
        ...
        for (var g = 0; g < a.length; ++g) e[e.length] = b.call(f, a[g], d);
      } else return !1;
      return e;
    },
    getDocumentHeight: function () {
      return Math.max(
        "CSS1Compat" != i.compatMode || l ? i.body.scrollHeight : j.scrollHeight,
    ...
    getAncestorByClassName: function (a, b) {
      ...
      return !a
        ? null
        : c.Dom.getAncestorBy(a, function (a) {
    ...
    getLastChildBy: function (a, b) {
      return !a
        ? null
        : (c.Dom._testElement(a.lastChild, b) ? a.lastChild : null) || c.Dom.getPreviousSiblingBy(a.lastChild, b);
    },
    ...
    _getClassRegex: function (a) {
      ...
      void 0 !== a &&
        (a.exec
          ...
          : ((b = f[a]),
            b ||
              ((a = a.replace(c.Dom._patterns.CLASS_RE_TOKENS, "\\$1")),
              (b = f[a] = RegExp("(?:^|\\s)" + a + "(?= |$)", "g")))));
      return b;
    },
  ...
  var c = YAHOO.util,
    ...
    d = {
      get: function (a, d) {
        ...
        return (e =
          "opacity" === d
            ? c.Dom.getStyle(a, "opacity")
            : !e || (e.indexOf && -1 < e.indexOf("px"))
              ? e
              : c.Dom.IE_COMPUTED[d]
                ? c.Dom.IE_COMPUTED[d](a, d)
                : b.test(e)
                  ? c.Dom.IE.ComputedStyle.getPixel(a, d)
                  : e);
      },
      getOffset: function (a, b) {
        var d = a.currentStyle[b],
          ...
          c = "";
        "auto" == d
          ? ((c = d = a[j]), e.test(b) && ((a.style[b] = d), a[j] > d && (c = d - (a[j] - d)), (a.style[b] = "auto")))
          : (!a.style[k] && !a.style[b] && (a.style[b] = d), (c = a.style[k]));
        return c + "px";
      },
  ...
  b.Dom.Color = {
    ...
    toHex: function (d) {
      ...
      if (b.Dom.Color.re_RGB.exec(d))
        var d = 1 === e.$2.length ? "0" + e.$2 : Number(e.$2),
          a = 1 === e.$3.length ? "0" + e.$3 : Number(e.$3),
          d = [(1 === e.$1.length ? "0" + e.$1 : Number(e.$1)).toString(16), d.toString(16), a.toString(16)].join("");
...
YAHOO.util.Event ||
  ((YAHOO.util.Event = (function () {
    var c = !1,
      ...
      h = [],
      i = 0,
      j = { 63232: 38, 63233: 40, 63234: 37, 63235: 39, 63276: 33, 63277: 34, 25: 9 },
    ...
    return {
      ...
      onDOMReady: function (a, b, d) {
        this.DOMReady
          ...
          : this.DOMReadyEvent.subscribe(a, b, d);
      },
      ...
      removeFocusListener: function (a, b) {
        return this.removeListener(a, k, b);
      },
      ...
      fireLegacyEvent: function (b, c) {
        ...
        for (var h = 0, k = e.length; h < k; ++h)
          if ((g = e[h]) && g[this.WFN]) ((j = g[this.ADJ_SCOPE]), (g = g[this.WFN].call(j, b)), (f = f && g));
        if ((e = d[c]) && e[2]) e[2](b);
        return f;
      },
      ...
      useLegacyEvent: function (a, b) {
        return this.webkit && 419 > this.webkit && ("click" == b || "dblclick" == b);
      },
      removeListener: function (d, c, f, g) {
        ...
        if ("unload" == c) {
          for (j = b.length - 1; -1 < j; j--)
            if ((k = b[j]) && k[0] == d && k[1] == c && k[2] == f) return (b.splice(j, 1), !0);
          return !1;
        }
        j = null;
      ...
      _ready: function () {
        var a = YAHOO.util.Event;
        a.DOMReady ||
          ((a.DOMReady = !0), a.DOMReadyEvent.fire(), a._simpleRemove(document, "DOMContentLoaded", a._ready));
      },
      _tryPreloadAttach: function () {
        if (0 === g.length) ((f = 0), this._interval && (clearInterval(this._interval), (this._interval = null)));
        else if (!this.locked)
      ...
      _unload: function (a) {
        ...
        for (j = b.length; f < j; ++f)
          if ((g = h[f]))
            ((k = window),
              g[c.ADJ_SCOPE] && (k = !0 === g[c.ADJ_SCOPE] ? g[c.UNLOAD_OBJ] : g[c.ADJ_SCOPE]),
              g[c.FN].call(k, c.getEvent(a, g[c.EL]), g[c.UNLOAD_OBJ]),
              (h[f] = null));
        b = null;
        if (e) for (a = e.length - 1; -1 < a; a--) (g = e[a]) && c.removeListener(g[c.EL], g[c.TYPE], g[c.FN], a);
        d = null;
  ...
  createEvent: function (c, e) {
    ...
    if (!d[c]) {
      ...
      if ((b = this.__yui_subscribers[c]))
        for (var f = 0; f < b.length; ++f) a.subscribe(b[f].fn, b[f].obj, b[f].overrideContext);
    }
    return d[c];
  },
    ...
    return {
      ...
      fireEvents: function (b, d) {
        ...
        if (a && !a.isLocked() && !a.dragOnly) {
          var c = YAHOO.util.Event.getPageX(b),
            ...
            e = a.getTargetCoord(h.x, h.y),
            i = a.getDragEl(),
            c = ["out", "over", "drop", "enter"],
            j = new YAHOO.util.Region(e.y, e.x + i.offsetWidth, e.y + i.offsetHeight, e.x),
            k = [],
            l = {},
            e = [],
            i = { outEvts: [], overEvts: [], dropEvts: [], enterEvts: [] },
            m;
            ...
            if ("string" == typeof o)
              for (m in this.ids[o]) {
                ...
                if (
                  ...
                  !n.isLocked() &&
                  n != a &&
                  this.isOverTarget(h, n, this.mode, j)
                ) {
                  l[o] = true;
                  if (d) i.dropEvts.push(n);
                  else {
      ...
      swapNode: function (b, d) {
        if (b.swapNode) b.swapNode(d);
          ...
          var a = d.parentNode,
            c = d.nextSibling;
          if (c == b) a.insertBefore(b, d);
          else if (d == b.nextSibling) a.insertBefore(d, b);
          else {
  ...
  YAHOO.util.DragDrop.prototype = {
    ...
    applyConfig: function () {
      ...
      if (this.config.events)
        for (var b in this.config.events) this.config.events[b] === false && (this.events[b] = false);
    ...
    handleMouseDown: function (b) {
      ...
      if (!(this.primaryButtonOnly && d > 1) && !this.isLocked()) {
        ...
        var e = this.onMouseDown(b),
          g = true;
        this.events.mouseDown && (g = this.fireEvent("mouseDownEvent", b));
    ...
    setYTicks: function (b, d) {
      this.yTicks = [];
      this.yTickSize = d;
      for (var a = {}, c = this.initPageY; c >= this.minY; c = c - d)
        if (!a[c]) {
    ...
    clearConstraints: function () {
      this.constrainY = this.constrainX = false;
      this.clearTicks();
    },
    clearTicks: function () {
    ...
    resetConstraints: function () {
      this.initPageX || this.initPageX === 0
  ...
  _resizeProxy: function () {
    if (this.resizeFrame) {
      var c = YAHOO.util.Dom,
        ...
        g = parseInt(c.getStyle(b, "borderLeftWidth"), 10);
      isNaN(d) && (d = 0);
      isNaN(a) && (a = 0);
      isNaN(f) && (f = 0);
      isNaN(g) && (g = 0);
  ...
  YAHOO.lang.augmentObject(
    c,
    {
      ...
      getSliderRegion: function (a, b, d, e, i, j, k) {
        return new c(a, a, new YAHOO.widget.SliderThumb(b, a, d, e, i, j, k), "region");
      },
      SOURCE_UI_EVENT: 1,
      SOURCE_SET_VALUE: 2,
      SOURCE_KEY_EVENT: 3,
  ...
  YAHOO.extend(c, YAHOO.util.DragDrop, {
    ...
    handleKeyDown: function (a) {
      if (this.enableKeys) {
        ...
        if (j) {
          e._isRegion
            ? this._setRegionValue(c.SOURCE_KEY_EVENT, h, i, true)
            : this._setValue(c.SOURCE_KEY_EVENT, e._isHoriz ? h : i, true);
          b.stopEvent(a);
        }
      }
    },
    ...
    moveThumb: function (a, b, d, h) {
      ...
      if (i.available) {
        ...
        if (this.animate && i._graduated && !d) {
          this.lock();
    ...
    moveOneTick: function (a) {
      ...
      } else c = b._isHoriz ? this._getNextX(this.curCoord, a) : this._getNextY(this.curCoord, a);
      if (c) {
        this.curCoord = c;
  ...
  c.prototype = {
    ...
    setValues: function (b, a, c, e, h) {
      var i = this.minSlider,
        ...
        o = false;
      if (k._isHoriz) {
        k.setXConstraint(k.leftConstraint, l.rightConstraint, k.tickSize);
    ...
    updateValue: function (b) {
      ...
      if (a != this.minVal || c != this.maxVal) {
        ...
        if (this.isHoriz) {
          ...
          i.setXConstraint(k, i.rightConstraint, i.tickSize);
        } else {
    ...
    selectActiveSlider: function (b) {
      var a = this.minSlider,
        ...
        h = c.isLocked() || !a.backgroundEnabled,
        i = YAHOO.util.Event;
      if (e || h) this.activeSlider = e ? c : a;
      else {
        b = this.isHoriz
          ? i.getPageX(b) - a.thumb.initPageX - a.thumbCenterPoint.x
          : i.getPageY(b) - a.thumb.initPageY - a.thumbCenterPoint.y;
...
YAHOO.util.Attribute.prototype = {
  ...
  setValue: function (c, e) {
    var b,
      d = this.owner,
      a = this.name,
      f = { type: a, prevValue: this.getValue(), newValue: c };
  ...
  YAHOO.util.AttributeProvider.prototype = {
    ...
    getAttributeKeys: function () {
      ...
      for (b in this._configs)
        c.hasOwnProperty(this._configs, b) && !c.isUndefined(this._configs[b]) && (e[e.length] = b);
      return e;
    },
    ...
    setAttributeConfig: function (c, b, d) {
      this._configs = this._configs || {};
      b = b || {};
      if (this._configs[c]) this._configs[c].configure(b, d);
      else {
        b.name = c;
...
(function () {
  ...
  b.prototype = {
    DOM_EVENTS: null,
    DEFAULT_HTML_SETTER: function (b, a) {
    ...
    appendTo: function (b, a) {
      ...
      var a = a && a.get ? a.get("element") : c.get(a),
        e = this.get("element");
      if (!e || !b) return false;
    ...
    set: function (b, a, c) {
      ...
      if (g) {
        !this._configs[b] && !YAHOO.lang.isUndefined(g[b]) && this._setHTMLAttrConfig(b);
    ...
    _initElement: function (d, a) {
      ...
      typeof a.element === "string" && this._setHTMLAttrConfig("id", { value: a.element });
      if (c.get(a.element)) {
        e = true;
    ...
    _initHTMLElement: function (b) {
      this.setAttributeConfig("element", { value: c.get(b.element), readOnly: true });
    },
  ...
  return {
    ...
    rgb2hsv: function (b, d, a) {
      ...
      var b = b / 255,
        ...
        a = a / 255,
        e,
        g = Math.min(Math.min(b, d), a),
        h = Math.max(Math.max(b, d), a),
        i = h - g;
      switch (h) {
        case g:
          e = 0;
...
(function () {
  ...
  YAHOO.extend(c, YAHOO.util.Element, {
          ...
          : b === 40
            ...
            : b >= 48 && b <= 57
              ...
              : b >= 97 && b <= 102
                ...
                : b >= 65 && b <= 70
                  ? 2
                  : "8, 9, 13, 27, 37, 39".indexOf(b) > -1 || a.ctrlKey || a.metaKey
                    ? 5
                    : 0;
    },
    ...
    _createElements: function () {
      ...
      b = new i("a", { id: f[this.ID.CONTROLS_LABEL], href: "#" });
      a.appendChild(b);
      e.appendChild(a);
      ...
      e.appendChild(a);
      a = new i("div", { id: f[this.ID.WEBSAFE_SWATCH], className: "yui-picker-websafe-swatch" });
      e.appendChild(a);
    },
    ...
    initAttributes: function (a) {
      ...
      this.setAttributeConfig(this.OPT.RGB, {
        ...
        method: function (a) {
          ...
          this.set(this.OPT.BLUE, a[2], true);
          var b = f.websafe(a),
            c = f.rgb2hex(a),
            a = f.rgb2hsv(a);
      ...
      this.setAttributeConfig(this.OPT.SHOW_HSV_CONTROLS, {
        value: d.isBoolean(a.showhsvcontrols) ? a.showhsvcontrols : false,
        method: function (a) {
...
(function () {
  ...
  e.prototype = {
    ...
    getAttribute: function (b) {
      var d = this.getEl(),
        a = c.Dom.getStyle(d, b);
      if (a !== "auto" && !this.patterns.offsetUnit.test(a)) return parseFloat(a);
      var e = this.patterns.offsetAttribute.exec(b) || [],
        g = !!e[3],
        h = !!e[2];
      "style" in d
        ? (a =
            h || (c.Dom.getStyle(d, "position") == "absolute" && g)
    ...
    getDefaultUnit: function (b) {
      return this.patterns.defaultUnit.test(b) ? "px" : "";
    },
        ...
        if (c.currentFrame < c.totalFrames || c.totalFrames === null) {
          ...
          if (c.useSeconds) {
            var g = c,
              h = g.totalFrames,
              i = g.currentFrame,
              j = (g.currentFrame * g.duration * 1e3) / g.totalFrames,
              k = new Date() - g.getStartTime(),
              l = 0,
              l = k < g.duration * 1e3 ? Math.round((k / j - 1) * g.currentFrame) : h - (i + 1);
            if (l > 0 && isFinite(l)) {
              g.currentFrame + l >= h && (l = h - (i + 1));
              g.currentFrame = g.currentFrame + l;
            }
          }
          c._onTween.fire();
...
(function () {
  ...
  d.parseColor = function (a) {
    ...
    return (b = this.patterns.hex3.exec(a)) && b.length == 4
      ? [parseInt(b[1] + b[1], 16), parseInt(b[2] + b[2], 16), parseInt(b[3] + b[3], 16)]
      : null;
  };
  d.getAttribute = function (a) {
    var d = this.getEl();
    if (this.patterns.color.test(a)) {
      var g = YAHOO.util.Dom.getStyle(d, a),
        h = this;
      if (this.patterns.transparent.test(g))
        g = (d = YAHOO.util.Dom.getAncestorBy(d, function () {
  ...
  d.setRuntimeAttribute = function (a) {
    ...
    if (this.patterns.color.test(a)) {
      var c = this.attributes,
        d = this.parseColor(this.runtimeAttributes[a].start),
        e = this.parseColor(this.runtimeAttributes[a].end);
      if (typeof c[a].to === "undefined" && typeof c[a].by !== "undefined")
        for (var e = this.parseColor(c[a].by), c = 0, i = d.length; c < i; ++c) e[c] = d[c] + e[c];
...
YAHOO.util.Easing = {
  ...
  elasticOut: function (c, e, b, d, a, f) {
    ...
    if (!a || a < Math.abs(b))
      var a = b,
        g = f / 4;
    else g = (f / (2 * Math.PI)) * Math.asin(b / a);
  ...
  elasticBoth: function (c, e, b, d, a, f) {
    ...
    return c < 1
      ? -0.5 * a * Math.pow(2, 10 * (c = c - 1)) * Math.sin(((c * d - g) * 2 * Math.PI) / f) + e
      : a * Math.pow(2, -10 * (c = c - 1)) * Math.sin(((c * d - g) * 2 * Math.PI) / f) * 0.5 + b + e;
  },
  ...
  backBoth: function (c, e, b, d, a) {
    typeof a == "undefined" && (a = 1.70158);
    return (c = c / (d / 2)) < 1
      ? (b / 2) * c * c * (((a = a * 1.525) + 1) * c - a) + e
      : (b / 2) * ((c = c - 2) * c * (((a = a * 1.525) + 1) * c + a) + 2) + e;
  },
  ...
  bounceOut: function (c, e, b, d) {
    return (c = c / d) < 1 / 2.75
      ? b * 7.5625 * c * c + e
      : c < 2 / 2.75
        ? b * (7.5625 * (c = c - 1.5 / 2.75) * c + 0.75) + e
        : c < 2.5 / 2.75
          ? b * (7.5625 * (c = c - 2.25 / 2.75) * c + 0.9375) + e
          : b * (7.5625 * (c = c - 2.625 / 2.75) * c + 0.984375) + e;
  },
  bounceBoth: function (c, e, b, d) {
    return c < d / 2
      ? YAHOO.util.Easing.bounceIn(c * 2, 0, b, d) * 0.5 + e
      : YAHOO.util.Easing.bounceOut(c * 2 - d, 0, b, d) * 0.5 + b * 0.5 + e;
  },
};
(function () {
  var c = function (a, b, d, e) {
  ...
  d.getAttribute = function (a) {
    return this.patterns.points.test(a)
      ? [b.getAttribute.call(this, "left"), b.getAttribute.call(this, "top")]
      : b.getAttribute.call(this, a);
  };
  d.doMethod = function (a, c, d) {
    var f = null;
    if (this.patterns.points.test(a)) {
  ...
  d.setRuntimeAttribute = function (c) {
    if (this.patterns.points.test(c)) {
      ...
      e.Dom.getStyle(d, "position") == "static" && e.Dom.setStyle(d, "position", "relative");
...
(function () {
  ...
  d.getAttribute = function (a) {
    var c = null,
      c = this.getEl();
    return (c = a == "scroll" ? [c.scrollLeft, c.scrollTop] : b.getAttribute.call(this, a));
  };
  d.setAttribute = function (a, c, d) {
    var e = this.getEl();
    if (a == "scroll") {
