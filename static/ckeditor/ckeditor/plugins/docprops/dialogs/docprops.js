  ...
  return {
    ...
    contents: [
                ...
                commit: function (a, d, e, b, c) {
                  c ||
                    ...
                    b &&
                      !this.metaCharset &&
                      (b =
                        (k["content-type"] ? k["content-type"].getAttribute("content").split(";")[0] : "text/html") +
                        "; charset=" +
                        b),
                    i(this.metaCharset ? "charset" : "content-type", 1, b).call(this, a, d, e));
                },
              },
              {
                type: "text",
          ...
          },
          {
            ...
            commit: function (a, d, c, b, f) {
              f ||
                (this.getValue()
                  ? ((g.xmlDeclaration =
                      '<?xml version="1.0" encoding="' + (this.getDialog().selectedCharset || "utf-8") + '"?>'),
                      ...
                      if (this.isChanged() || f)
                        (b.removeAttribute("bgcolor"),
                          (a = this.getValue())
                            ...
                            : n(b, "background-color", "transparent"));
                    },
                  }),
                  {
                    type: "hbox",
                  ...
                  },
                  {
                    ...
                    commit: function (a, d, c, b) {
                      this.getValue()
                        ...
                        : n(b, "background-attachment", "scroll");
                    },
                  },
                ],
              },
      ...
      },
      {
        ...
        label: c.meta,
        elements: [
          { type: "textarea", id: "metaKeywords", label: c.metaKeywords, setup: j("keywords"), commit: i("keywords") },
          {
            type: "textarea",
            id: "metaDescription",
        ...
        elements: [
          {
            ...
            id: "previewHtml",
            html:
              '<iframe src="' + q + '" style="width: 100%; height: 310px" hidefocus="true" frameborder="0"></iframe>',
            onLoad: function () {
