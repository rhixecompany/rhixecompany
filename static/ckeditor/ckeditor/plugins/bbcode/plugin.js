...
(function () {
  ...
  var j = {
    ...
    t = { strong: "b", b: "b", u: "u", em: "i", i: "i", code: "code", li: "*" },
    k = {
      strong: "b",
      em: "i",
      u: "u",
    ...
    u = { color: "color", size: "font-size" },
    v = { url: "href", email: "mailhref", quote: "cite", list: "listType" },
    l = CKEDITOR.dtd,
    w = CKEDITOR.tools.extend({ table: 1 }, l.$block, l.$listItem, l.$tableContent, l.$list),
    y = /\s*(?:;\s*|$)/,
    n = {
      smiley: ":)",
      sad: ":(",
  ...
  for (p in n)
    ((x[n[p]] = p),
      o.push(
        n[p].replace(/\(|\)|\:|\/|\*|\-|\|/g, function (a) {
          return "\\" + a;
        }),
      ));
  var o = RegExp(o.join("|"), "g"),
    z = (function () {
      var a = [],
        b = { nbsp: " ", shy: "­" },
        c;
  ...
  CKEDITOR.BBCodeParser.prototype = {
    parse: function (a) {
      for (var b, c, h = 0; (b = this._.bbcPartsRegex.exec(a));) {
        ...
        if ((c = (b[1] || b[3] || "").toLowerCase()) && !j[c]) this.onText(b[0]);
        else if (b[1]) {
          var f = j[c],
            i = {},
            g = {};
            ...
            if (
              ...
              for (d in g)
                var q = (d + ":" + g[d]).replace(y, ";"),
                  e = e + q;
              b.style = e;
            } else v[c] && (i[v[c]] = CKEDITOR.tools.htmlDecode(b));
  ...
  CKEDITOR.htmlParser.fragment.fromBBCode = function (a) {
    function b(a) {
      if (0 < g.length)
        for (var f = 0; f < g.length; f++) {
          ...
          if ((!e || e[c]) && (!a || !i || i[a] || !CKEDITOR.dtd[a]))
    ...
    function c(f, a) {
      var b = d.children.length,
        ...
        b = !c && r.getRule(k[d.name], "breakAfterOpen"),
        c = c && c.type == CKEDITOR.NODE_ELEMENT && r.getRule(k[c.name], "breakAfterClose"),
        i = f && r.getRule(k[f], a ? "breakBeforeClose" : "breakBeforeOpen");
      e && (b || c || i) && e--;
      e && f in w && e++;
    ...
    f.onTagOpen = function (a, i) {
      ...
      if (CKEDITOR.dtd.$removeEmpty[a]) g.push(e);
        ...
        var s = d.name,
          m = s && (CKEDITOR.dtd[s] || (d._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span));
        if (m && !m[a]) {
          var m = !1,
            j;
          a == s
            ? h(d, d.parent)
            : (a in CKEDITOR.dtd.$listItem ? (f.onTagOpen("ul", {}), (j = d)) : (h(d, d.parent), g.unshift(d)),
              (m = !0));
    ...
    for (f.parse(CKEDITOR.tools.htmlEncode(a)); d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT;)
        ...
        elements: {
          ...
          smiley: function (a) {
            ...
            var b = a.attributes.desc,
              g = c.smiley_images[CKEDITOR.tools.indexOf(c.smiley_descriptions, b)],
          ...
          elements: {
            $: function (b) {
              ...
              if (d in t) d = t[d];
                ...
                if ((e = g.color)) ((d = "color"), (e = CKEDITOR.tools.convertRgbToHex(e)));
                else {
                ...
                try {
                  var h = b.children[0],
                    j = b.children[1],
                    k = "cite" == h.name && h.children[0].value;
                ...
                if ((e = c.href))
                  -1 !== e.indexOf("mailto:")
                    ? ((d = "email"), (b.children = [new CKEDITOR.htmlParser.text(e.replace("mailto:", ""))]), (e = ""))
