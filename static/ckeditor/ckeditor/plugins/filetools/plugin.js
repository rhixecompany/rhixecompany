...
(function () {
  ...
  function i(a, b, c) {
    ...
    this.lang = a.lang;
    "string" === typeof b
      ? ((this.data = b), (this.file = k(this.data)), (this.loaded = this.total = this.file.size))
      : ((this.data = null), (this.file = b), (this.total = this.file.size), (this.loaded = 0));
    c
      ? (this.fileName = c)
      : this.file.name
        ? (this.fileName = this.file.name)
        : ((a = this.file.type.split("/")), d && (a[0] = d), (this.fileName = a.join(".")));
    this.uploaded = 0;
    this.status = "created";
    this.abort = function () {
  ...
  CKEDITOR.plugins.add("filetools", {
    ...
    beforeInit: function (a) {
      ...
      a.on(
        "fileUploadRequest",
        function (a) {
          var a = a.data.fileLoader,
            c = new FormData();
          c.append("upload", a.file, a.fileName);
          a.xhr.send(c);
        },
        null,
        null,
      ...
      a.on(
        ...
        function (a) {
          ...
          try {
            ...
            e.uploaded ? ((f.fileName = e.fileName), (f.url = e.url)) : a.cancel();
          } catch (g) {
            ((f.message = c.lang.filetools.responseError),
              window.console && window.console.log(d.responseText),
              a.cancel());
          }
        },
        null,
  ...
  h.prototype = {
    create: function (a, b) {
      var c = this.loaders.length,
        d = new i(this.editor, a, b);
      d.id = c;
      this.loaders[c] = d;
  ...
  i.prototype = {
    ...
    upload: function (a) {
      a
        ? ((this.uploadUrl = a),
          ...
          this.editor.fire("fileUploadRequest", { fileLoader: this }) && this.changeStatus("uploading"))
    ...
    attachRequestListeners: function () {
      ...
      b.onerror = function () {
        a.message = a.lang.filetools.networkError;
        a.changeStatus("error");
      };
      b.onprogress = function (b) {
        a.uploaded = b.loaded;
      ...
      b.onload = function () {
        ...
        if (200 > b.status || 299 < b.status)
          ((a.message = a.lang.filetools["httpError" + b.status]),
            a.message || (a.message = a.lang.filetools.httpError.replace("%1", b.status)),
            a.changeStatus("error"));
        else {
          for (
            var c = { fileLoader: a },
              d = ["message", "fileName", "url"],
              f = a.editor.fire("fileUploadResponse", c),
              e = 0;
            e < d.length;
            e++
          ) {
            var g = d[e];
            "string" === typeof c[g] && (a[g] = c[g]);
          }
          !1 === f ? a.changeStatus("error") : a.changeStatus("uploaded");
        }
      };
    },
      ...
      return b && a[b + "UploadUrl"]
        ...
        : a.uploadUrl
          ...
          : b && a["filebrowser" + c(b, 1) + "UploadUrl"]
            ? a["filebrowser" + c(b, 1) + "UploadUrl"] + "&responseType=json"
            : a.filebrowserUploadUrl
              ? a.filebrowserUploadUrl + "&responseType=json"
              : null;
    },
