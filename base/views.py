...
from .forms import CustomUserCreationForm, PostForm, ProfileForm, UserForm
from .models import *
...
def post(request, slug):
    ...
    if request.method == "POST":
        PostComment.objects.create(author=request.user.profile, post=post, body=request.POST["comment"])
...
def sendEmail(request):
    ...
    if request.method == "POST":
        ...
        email = EmailMessage(request.POST["subject"], template, settings.EMAIL_HOST_USER, ["rhixecompany@gmail.com"])
