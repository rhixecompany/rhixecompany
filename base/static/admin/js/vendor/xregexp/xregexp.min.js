  ...
  (function (n) {
      ...
      return (
        ...
        (n =
          n.xregexp && !n.xregexp.isNative
            ? v(t(n.source, f), n.xregexp.captureNames ? n.xregexp.captureNames.slice(0) : null)
        ...
        while (o--)
          if (
            ...
            (f.scope === "all" || f.scope === i) &&
              ...
              ((f.pattern.lastIndex = t), (e = r.exec.call(f.pattern, n)), e && e.index === t))
          ) {
    ...
    return (
      ...
      (t.replace = function (i, u, f, e) {
        ...
        return (
          c
            ? (e === n && u.global && (e = "all"), (s = o(u, e === "all" ? "g" : "", e === "all" ? "" : "g")))
      ...
      (t.union = function (n, i) {
        ...
        for (u = 0; u < n.length; ++u)
          ((r = n[u]),
            t.isRegExp(r)
              ? ((f = o), (h = (r.xregexp && r.xregexp.captureNames) || []), e.push(t(r.source).source.replace(l, c)))
              : e.push(t.escape(r)));
        return t(e.join("|"), i);
      }),
      (t.version = "2.0.0"),
      ...
      (r.replace = function (n, r) {
        var e = t.isRegExp(n),
          ...
          o;
        return (
          e ? (n.xregexp && (u = n.xregexp.captureNames), n.global || (o = n.lastIndex)) : (n += ""),
          s(r, "function")
  ...
  function o(t) {
    ...
    return (
      n.forEach(t, /\\u(\w{4})(?:-\\u(\w{4}))?/, function (n) {
        ((o = f(n[1])),
          o > i + 1 && (e.push("\\u" + u(r(i + 1))), o > i + 2 && e.push("-\\u" + u(r(o - 1)))),
          (i = f(n[2] || n[1])));
      }),
      i < 65535 && (e.push("\\u" + u(r(i + 1))), i < 65534 && e.push("-\\uFFFF")),
      e.join("")
    );
  }
  function e(n) {
...
(function (n) {
  ...
  n.build = function (f, e, o) {
    ...
    for (c in e)
      e.hasOwnProperty(c) && ((a = t(e[c])), (l[c] = { pattern: u(a.source), names: a.xregexp.captureNames || [] }));
    return (
      (f = t(f)),
