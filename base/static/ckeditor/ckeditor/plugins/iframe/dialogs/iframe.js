...
(function () {
  function d(c) {
    ...
    c.hasAttribute(this.id) &&
      ((c = c.getAttribute(this.id)), d ? this.setValue(f[this.id]["true"] == c.toLowerCase()) : this.setValue(c));
  }
  function e(c) {
    var d = "" === this.getValue(),
      ...
      contents: [
        {
          ...
          elements: [
            ...
            },
            {
              ...
              widths: ["50%", "50%"],
              children: [
                { id: "name", type: "text", requiredContent: "iframe[name]", label: a.name, setup: d, commit: e },
                {
                  id: "title",
                  type: "text",
