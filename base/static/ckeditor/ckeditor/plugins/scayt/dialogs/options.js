                ...
                onShow: function (b) {
                  ...
                  setTimeout(function () {
                    ...
                    null != g.getUserDictionaryName() &&
                      ...
                      a.getContentElement("dictionaries", "dictionaryName").setValue(g.getUserDictionaryName());
                  }, 0);
                },
              },
              {
                  ...
                  },
                  {
                    ...
                    onClick: function () {
                      ...
                      a.isLicensed() &&
                        ...
                        d.fire("scaytUserDictionaryAction", { dialog: b, command: "disconnect", name: e }));
                    },
                  },
                  {
                    type: "button",
    ...
    buildRadioInputs: function (b, a, c) {
      ...
      var h = "scaytLang_" + d.name + "_" + a,
        e = CKEDITOR.dom.element.createFromHtml(
          '\x3cinput id\x3d"' + h + '" type\x3d"radio"  value\x3d"' + a + '" name\x3d"scayt_lang" /\x3e',
        ),
    ...
    toggleDictionaryState: function (b) {
      ...
      switch (b) {
        ...
        case "dictionaryState":
          (a.show(), c.show(), d.hide(), e.hide(), f.show(), l.show(), k.show(), m.show(), n.hide(), p.hide());
      }
    },
