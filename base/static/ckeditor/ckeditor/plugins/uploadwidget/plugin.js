...
(function () {
  ...
  CKEDITOR.tools.extend(CKEDITOR.fileTools, {
      ...
      CKEDITOR.tools.extend(a, {
          ...
          e.on("update", function (h) {
            if (!a.wrapper || !a.wrapper.getParent()) {
              ...
              if (!(typeof a[h] === "function" && a[h](e) === false)) {
                ...
                (e.status == "error" || e.status == "abort") && b.widgets.del(a);
              }
        ...
        replaceWith: function (a, c) {
          if (a.trim() === "") b.widgets.del(this);
            ...
            b.widgets.checkWidgets({ initOnlyNew: true });
    ...
    markElement: function (b, c, a) {
      b.setAttributes({ "data-cke-upload-id": a, "data-widget": c });
    },
    bindNotifications: function (b, c) {
      var a = b._.uploadWidgetNotificaionAggregator;
      if (!a || a.isFinished()) {
        a = b._.uploadWidgetNotificaionAggregator = new CKEDITOR.plugins.notificationAggregator(
          b,
          b.lang.uploadwidget.uploadMany,
          b.lang.uploadwidget.uploadOne,
        );
        a.once("finished", function () {
          ...
          c === 0
            ...
            : a.notification.update({
                message: c == 1 ? b.lang.uploadwidget.doneOne : b.lang.uploadwidget.doneMany.replace("%1", c),
                type: "success",
                important: 1,
              });
        });
      }
      var f = a.createTask({ weight: c.total });
