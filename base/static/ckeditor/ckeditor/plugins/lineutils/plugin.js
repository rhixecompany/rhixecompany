...
(function () {
  ...
  function j(a) {
    return (
      ...
      !(o[a.getComputedStyle("float")] || o[a.getAttribute("align")]) &&
      !r[a.getComputedStyle("position")]
    );
  }
  ...
  k.prototype = {
    start: function (a) {
      var d = this,
        ...
        f,
        h,
        i = CKEDITOR.tools.eventsBuffer(50, function () {
          if (!(b.readOnly || "wysiwyg" != b.mode))
            if (((d.relations = {}), (g = c.$.elementFromPoint(f, h)) && g.nodeType))
    ...
    store: (function () {
      ...
      return function (d, b) {
        var c;
        if (b & CKEDITOR.LINEUTILS_AFTER && j((c = d.getNext())) && c.isVisible())
          (a(c, CKEDITOR.LINEUTILS_BEFORE, this.relations), (b ^= CKEDITOR.LINEUTILS_AFTER));
        if (b & CKEDITOR.LINEUTILS_INSIDE && j((c = d.getFirst())) && c.isVisible())
    ...
    pixelSearch: (function () {
      function a(a, c, e, g, f) {
        for (var h = 0, i; f(e);) {
          e += g;
          if (25 == ++h) break;
          if ((i = this.doc.$.elementFromPoint(c, e)))
            if (i == a) h = 0;
            else if (d(a, i) && ((h = 0), j((i = new CKEDITOR.dom.element(i))))) return i;
        }
      }
      var d =
  ...
  var n = {
    ...
    q = { height: "0px", "border-top": "1px dashed red", position: "absolute", "z-index": 9999 },
    p =
      '<div data-cke-lineutils-line="1" class="cke_reset_all" style="{lineStyle}"><span style="{tipLeftStyle}">&nbsp;</span><span style="{tipRightStyle}">&nbsp;</span></div>';
  m.prototype = {
    removeAll: function () {
    ...
    getStyle: function (a, d) {
      ...
      if (this.inline) e.left = b.elementRect.left - this.rect.relativeX;
      else if (
    ...
    getClientRect: function (a) {
      var a = a.getClientRect(),
        d = this.container.getDocumentPosition(),
  ...
  var o = { left: 1, right: 1, center: 1 },
    r = { absolute: 1, fixed: 1 };
