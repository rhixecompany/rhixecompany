...
(function () {
      ...
      w = {
        ...
        elements: {
          a: function (d) {
            ...
            d.attributes.name &&
              A[d.attributes.name] &&
              ((d = A[d.attributes.name]), (d.attributes.href = d.attributes.href.replace(/.*#(.*)$/, "#$1")));
          },
          div: function (d) {
            ...
            if (g.thisIsAListItem(a, d))
              (p.isEdgeListItem(a, d) && p.cleanupEdgeListItem(d),
                ...
                n.array.reduce(
                  ...
                  function (a, d) {
                    "p" === d.name &&
                      (0 < a && new CKEDITOR.htmlParser.element("br").insertBefore(d),
              ...
              b &&
                ...
                (b.attributes["cke-list-level"] = e["mso-list"].match(/level(\d+)/)[1]);
          ...
          font: function (d) {
            ...
            CKEDITOR.tools.arrayCompare(CKEDITOR.tools.object.keys(d.attributes), ["class", "style"])
              ? k.createStyleStack(d, c, a)
              : C(d, c);
          },
          ul: function (a) {
          ...
          "v:shape": function (a) {
            ...
            if (null === a.getFirst("v:imagedata")) e(a);
              ...
              "v:group" === a.parent.name
                ...
                : (a.forEach(
                    function (a) {
                      a.attributes && a.attributes.src && (f = a.attributes.src);
                    },
          ...
          br: function (b) {
            if (
              ...
              "always" === b["page-break-before"] || "page" === b["break-before"])
            )
              return (
  ...
  q.lists = {
    thisIsAListItem: function (b, a) {
      return p.isEdgeListItem(b, a) ||
        (a.attributes.style && a.attributes.style.match(/mso\-list:\s?l\d/) && "li" !== a.parent.name) ||
    ...
    removeSymbolText: function (b) {
      ...
      c &&
        ...
        (e = c.parent),
        e.getHtml().match(/^(\s|&nbsp;)*$/) && e !== b ? e.remove() : c.value || c.remove());
    },
    ...
    numbering: {
      ...
      getStyle: function (b) {
        ...
        a || ((a = "decimal"), b.match(/[a-z]/) && (a = "lower-alpha"), b.match(/[A-Z]/) && (a = "upper-alpha"));
        return a;
      },
    },
    ...
    createLists: function (b) {
        ...
        return CKEDITOR.tools.array.reduce(
          ...
          function (a, b) {
            if (b.attributes && b.attributes.style)
              var c = CKEDITOR.tools.parseCssText(b.attributes.style)["margin-left"];
      ...
      for (b = 0; b < k.length; b++) {
        ...
        for (f = 0; f < d.length; f++) {
          ...
          for (; e < h.length;)
            (h.pop(), (m = h[h.length - 1]), e == h.length && g.setListSymbol(m, c.attributes["cke-symbol"], e));
          c.remove();
          m.add(c);
        }
        h[0].children.length &&
    ...
    cleanup: function (b) {
      var a = ["cke-list-level", "cke-symbol", "cke-list-id", "cke-indentation", "cke-dissolved"],
        c,
        e;
      for (c = 0; c < b.length; c++) for (e = 0; e < a.length; e++) delete b[c].attributes[a[e]];
    },
    determineListItemValue: function (b) {
      if ("ol" === b.parent.name) {
        ...
        c &&
          ((c = c[c.length - 1]),
          (e = b.parent.attributes["cke-list-style-type"] || this.numbering.getStyle(c)),
    ...
    calculateValue: function (b) {
      ...
      for (g = b; 0 <= g && null === c; g--)
        ((f = a.children[g]),
          f.attributes && void 0 !== f.attributes.value && ((e = g), (c = parseInt(f.attributes.value, 10))));
      ...
      for (var c = {}, e = [[]], f, l = 0; l < b.length; l++) {
        ...
        k
          ? ((m = k.type.match(/alpha/) && 7 == k.index ? "alpha" : m),
            (m = "o" == b[l].attributes["cke-symbol"] && 14 == k.index ? "alpha" : m),
            (h = g.getSymbolInfo(b[l].attributes["cke-symbol"], m)),
            (d = this.getListItemInfo(b[l])),
            (k.type != h.type || (f && d.id != f.id && !this.isAListContinuation(b[l]))) && e.push([]))
    ...
    getSymbolInfo: function (b, a) {
      ...
      if (b in e || (a && a.match(/(disc|circle|square)/))) return { index: e[b][1], type: e[b][0] };
      if (b.match(/\d/)) return { index: b ? parseInt(g.getSubsectionSymbol(b), 10) : 0, type: "decimal" };
    ...
    getListItemInfo: function (b) {
      if (void 0 !== b.attributes["cke-list-id"])
        return { id: b.attributes["cke-list-id"], level: b.attributes["cke-list-level"] };
      var a = n.parseCssText(b.attributes.style)["mso-list"],
        c = { id: "0", level: "1" };
      a && ((a += " "), (c.level = a.match(/level(.+?)\s+/)[1]), (c.id = a.match(/l(\d+?)\s+/)[1]));
      b.attributes["cke-list-level"] =
        void 0 !== b.attributes["cke-list-level"] ? b.attributes["cke-list-level"] : c.level;
    ...
    extractFromRtf: function (b) {
      ...
      for (var f = 0; f < b.length; f++)
        if (c.test(b[f])) {
          ...
          a.push({ hex: e ? b[f].replace(c, "").replace(/[^\da-fA-F]/g, "") : null, type: e });
        }
      return a;
    },
  ...
  q.heuristics = {
    isEdgeListItem: function (b, a) {
      ...
      return c.match(/^(?: |&nbsp;)*\(?[a-zA-Z0-9]+?[\.\)](?: |&nbsp;){2,}/) ? !0 : p.isDegenerateListItem(b, a);
    },
    ...
    isDegenerateListItem: function (b, a) {
      return (
        ...
        (a.attributes.style &&
          ...
          !!a.find(function (b) {
            if (b.type == CKEDITOR.NODE_ELEMENT && a.name.match(/h\d/i) && b.getHtml().match(/^[a-zA-Z0-9]+?[\.\)]$/))
              return !0;
    ...
    assignListLevels: function (b, a) {
      if (!a.attributes || void 0 === a.attributes["cke-list-level"]) {
        for (
          ...
          a.next && a.next.attributes && !a.next.attributes["cke-list-level"] && p.isDegenerateListItem(b, a.next);
        )
      ...
      if (this.isShifted(b)) {
        var a = CKEDITOR.tools.array.filter(b.children, function (a) {
          ...
          c = CKEDITOR.tools.array.reduce(
            a,
            function (a, b) {
              return (b.children && 1 == b.children.length && p.isShifted(b.children[0]) ? [b] : b.children).concat(a);
            },
            [],
          );
  ...
  g.setListSymbol.removeRedundancies = function (b, a) {
    ((1 === a && "disc" === b["list-style-type"]) || "decimal" === b["list-style-type"]) && delete b["list-style-type"];
  };
