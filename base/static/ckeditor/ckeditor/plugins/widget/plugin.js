...
(function () {
      ...
      exec: function (a, d) {
        ...
        if (f && f.name == b.name) f.edit();
          ...
          var f = "function" == typeof b.defaults ? b.defaults() : b.defaults,
            ...
            g,
            j = a.widgets.wrapElement(f, b.name),
            i = new CKEDITOR.dom.documentFragment(j.getDocument());
          i.append(j);
  ...
  function M(a, b) {
    function c(b, c, d) {
      ...
      a._.upcasts.splice(e, 0, [b, c, d]);
    }
    var d = b.upcast,
      e = b.upcastPriority || 10;
    if (d)
      if ("string" == typeof d) for (d = d.split(","); d.length;) c(b.upcasts[d.pop()], b.name, e);
      else c(d, b.name, e);
  }
  function q(a, b) {
    a.focused = null;
    ...
    if ("wysiwyg" == this.editor.mode) {
      ...
      if (b) {
        ...
        if (a && a.initOnlyNew) c = this.initOnAll();
          ...
          var j = b.find(".cke_widget_wrapper"),
            c = [];
          d = 0;
          for (e = j.count(); d < e; d++) {
            f = j.getItem(d);
            ...
            g && (f.addClass("cke_widget_new"), c.push(this.initOn(f.getFirst(h.isDomWidgetElement))));
          }
        }
    ...
    return {
      ...
      iterator: function (a) {
        ...
        if ((l = c.length)) {
          ...
          i = 0;
          for (f = d.length; i < f; ++i) if (!1 === d[i](a)) return;
          for (i = 0; i < l; ++i)
            if (((f = c[i]), (j = {}), (g = f[0](a, j))))
              return (
                g instanceof CKEDITOR.htmlParser.element && (a = g),
                (a.attributes["data-cke-widget-data"] = encodeURIComponent(JSON.stringify(j))),
  ...
  function I(a) {
    ...
    b.on("drop", function (c) {
      var e = c.data.dataTransfer,
        ...
        g = b.createRange();
      if (!("" === f || e.getTransferType(b) != CKEDITOR.DATA_TRANSFER_INTERNAL))
        if ((e = a.instances[f]))
          (g.setStartBefore(e.wrapper),
            g.setEndAfter(e.wrapper),
            (c.data.dragRange = g),
            ...
            c.data.dataTransfer.setData("text/html", b.editable().getHtmlFromRange(g).getHtml()),
  ...
  function G(a) {
    ...
    b.on("contentDom", function () {
      ...
      c.attachListener(d, "mousedown", function (b) {
        ...
        f = 0;
        e &&
          (e.inline && c.type == CKEDITOR.NODE_ELEMENT && c.hasAttribute("data-cke-widget-drag-handler")
            ? (f = 1)
            : h.getNestedEditable(e.wrapper, c)
              ? (e = null)
              : (b.data.preventDefault(), CKEDITOR.env.ie || e.focus()));
      });
  ...
  function J(a) {
    function b(b) {
      a.focused && v(a.focused, "cut" == b.name);
    }
    var c = a.editor;
  ...
  function F(a) {
    ...
    b.on("selectionChange", function (c) {
      var d = (c = h.getNestedEditable(b.editable(), c.data.selection.getStartElement())) && a.getByElement(c),
        e = a.widgetHoldingFocusedEditable;
      if (e) {
        if (e !== d || !e.focusedEditable.equals(c)) (m(a, e, null), d && c && m(a, d, c));
      } else d && c && m(a, d, c);
    });
    ...
    b.on("blur", function () {
      var b;
      (b = a.focused) && q(a, b);
      (b = a.widgetHoldingFocusedEditable) && m(a, b, null);
    });
  }
  function D(a) {
    var b = a.editor,
    ...
    b.on(
      ...
      function (a) {
        if (a.data.downcastingSessionId)
          for (var a = c[a.data.downcastingSessionId], b, f, g, j, h, l; (b = a.shift());) {
            f = b.widget;
            g = b.element;
            j = f._.downcastFn && f._.downcastFn.call(f, g);
            for (l in b.editables)
              ((h = b.editables[l]), delete h.attributes.contenteditable, h.setHtml(f.editables[l].getData()));
            j || (j = g);
            b.wrapper.replaceWith(j);
          }
      },
      null,
      null,
  ...
  function C(a) {
    ...
    b.on(
      ...
      function (b) {
        ...
        for (b.data.dataValue.forEach(d.iterator, CKEDITOR.NODE_ELEMENT, !0); (g = d.toBeWrapped.pop());) {
          var j = g[0],
            i = j.parent;
          i.type == CKEDITOR.NODE_ELEMENT && i.attributes["data-cke-widget-wrapper"] && i.replaceWith(j);
    ...
    b.on("dataReady", function () {
      if (d)
        for (var c = b.editable().find(".cke_widget_wrapper"), f, g, j = 0, i = c.count(); j < i; ++j)
          ((f = c.getItem(j)),
            (g = f.getFirst(h.isDomWidgetElement)),
            g.type == CKEDITOR.NODE_ELEMENT && g.data("widget") ? (g.replace(f), a.wrapElement(g)) : f.remove());
      d = 0;
      a.destroyAll(!0);
      a.initOnAll();
    });
    ...
    b.on("paste", function (a) {
      a = a.data;
      a.dataValue = a.dataValue.replace(R, Q);
      if (a.range && (a = h.getNestedEditable(b.editable(), a.range.startContainer)))
        (a = CKEDITOR.filter.instances[a.data("cke-filter")]) && b.setActiveFilter(a);
    });
  ...
  function w(a) {
    ...
    return {
      ...
      commit: function () {
        ...
        for (f && (g = a.focused) && q(a, g); (g = d.pop());)
          (b.splice(CKEDITOR.tools.indexOf(b, g), 1),
            g.isInited() && ((h = g.editor.checkDirty()), g.setSelected(!1), !h && g.editor.resetDirty()));
        f &&
          e &&
  ...
  function v(a, b) {
    ...
    if (!d.getById("cke_copybin")) {
      ...
      g.append(f);
      c.editable().append(g);
      var i = c.on("selectionChange", z, null, null, 0),
        l = a.repository.on("checkSelection", z, null, null, 0);
      if (e)
        var k = d.getDocumentElement().$,
          m = k.scrollTop;
      h = c.createRange();
  ...
  function T(a) {
    if (a.draggable) {
      ...
      if (!a.inline && (d.on("mousedown", U, a), CKEDITOR.env.ie && 9 > CKEDITOR.env.version))
  ...
  function U(a) {
    function b() {
      var b;
      for (k.reset(); (b = h.pop());) b.removeListener();
      var c = i;
      b = a.sender;
    ...
    var l = c.greedySearch(),
      k = CKEDITOR.tools.eventsBuffer(50, function () {
        m = d.locate(l);
        i = d.sort(n, 1);
        i.length && (e.prepare(l, m), e.placeLine(i[0]), e.cleanup());
      }),
      m,
      n;
      ...
      function (b) {
        ...
        if (13 == b) a.edit();
          ...
          if (b == CKEDITOR.CTRL + 67 || b == CKEDITOR.CTRL + 88) {
            v(a, b == CKEDITOR.CTRL + 88);
            return;
          }
          if (b in Z || CKEDITOR.CTRL & b || CKEDITOR.ALT & b) return;
        }
        return !1;
      },
      null,
  ...
  CKEDITOR.plugins.add("widget", {
    lang: "af,ar,bg,ca,cs,cy,da,de,el,en,en-gb,eo,es,fa,fi,fr,gl,he,hr,hu,it,ja,km,ko,ku,lv,nb,nl,no,pl,pt,pt-br,ru,sk,sl,sq,sv,tr,tt,uk,vi,zh,zh-cn",
    ...
    onLoad: function () {
      CKEDITOR.addCss(
        ".cke_widget_wrapper{position:relative;outline:none}.cke_widget_inline{display:inline-block}.cke_widget_wrapper:hover>.cke_widget_element{outline:2px solid yellow;cursor:default}.cke_widget_wrapper:hover .cke_widget_editable{outline:2px solid yellow}.cke_widget_wrapper.cke_widget_focused>.cke_widget_element,.cke_widget_wrapper .cke_widget_editable.cke_widget_editable_focused{outline:2px solid #ace}.cke_widget_editable{cursor:text}.cke_widget_drag_handler_container{position:absolute;width:" +
          k +
          "px;height:0;display:none;opacity:0.75;transition:height 0s 0.2s;line-height:0}.cke_widget_wrapper:hover>.cke_widget_drag_handler_container{height:" +
          k +
          "px;transition:none}.cke_widget_drag_handler_container:hover{opacity:1}img.cke_widget_drag_handler{cursor:move;width:" +
          k +
          "px;height:" +
          k +
          "px;display:inline-block}.cke_widget_mask{position:absolute;top:0;left:0;width:100%;height:100%;display:block}.cke_editable.cke_widget_dragging, .cke_editable.cke_widget_dragging *{cursor:move !important}",
      );
    },
    ...
    afterInit: function (a) {
      ...
      for (d in b)
        ((c = b[d]),
          (e = c.button) &&
            a.ui.addButton &&
            a.ui.addButton(CKEDITOR.tools.capitalize(c.name, !0), { label: e, command: c.name, toolbar: "insert,10" }));
      P(a);
    },
  });
  n.prototype = {
    ...
    destroy: function (a, b) {
      this.widgetHoldingFocusedEditable === a && m(this, a, null, b);
      a.destroy(b);
    ...
    finalizeCreation: function (a) {
      if ((a = a.getFirst()) && h.isDomWidgetWrapper(a))
    ...
    initOn: function (a, b, c) {
      ...
      return d
        ? d.hasClass("cke_widget_new")
          ? ((a = new h(this, this._.nextId++, a, b, c)), a.isInited() ? (this.instances[a.id] = a) : null)
          : this.getByElement(a)
        : null;
    },
    initOnAll: function (a) {
      for (var a = (a || this.editor.editable()).find(".cke_widget_new"), b = [], c, d = a.count(); d--;)
    ...
    parseElementClasses: function (a) {
      if (!a) return null;
      for (var a = CKEDITOR.tools.trim(a).split(/\s+/), b, c = {}, d = 0; (b = a.pop());)
    ...
    wrapElement: function (a, b) {
      ...
      if (a instanceof CKEDITOR.dom.element) {
        ...
        e = u(d, a.name);
        c = new CKEDITOR.htmlParser.element(e ? "span" : "div", s(e));
    ...
    _tests_createEditableFilter: r,
  };
  CKEDITOR.event.implementOn(n.prototype);
  h.prototype = {
    addClass: function (a) {
    ...
    destroyEditable: function (a, b) {
      ...
      c.removeListener("focus", B);
      c.removeListener("blur", A);
    ...
    initEditable: function (a, b) {
      ...
      return c && c.is(CKEDITOR.dtd.$editable)
        ? ((c = new o(this.editor, c, { filter: r.call(this.repository, this.name, a, b) })),
          (this.editables[a] = c),
          c.setAttributes({
          ...
          c.on("focus", B, this),
          CKEDITOR.env.ie && c.on("blur", A, this),
    ...
    _findOneNotNested: function (a) {
      for (var a = this.wrapper.find(a), b, c, d = 0; d < a.count(); d++)
    ...
    updateDragHandlerPosition: function () {
      var a = this.editor,
        ...
        b = { x: b.offsetLeft, y: b.offsetTop - k };
  ...
  var R = RegExp(
    ...
    Z = { 37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1 };
  (function () {
    function a() {}
    function b(a, b, e) {
    ...
    CKEDITOR.style.addCustomHandler({
      ...
      toAllowedContentRules: function (a) {
        if (!a) return null;
        var a = a.widgets.registered[this.widget],
          b,
          e = {};
        if (!a) return null;
