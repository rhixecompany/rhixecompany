...
(function () {
  ...
  jQuery.fn = jQuery.prototype = {
    ...
    add: function (selector) {
      return this.pushStack(
        jQuery.unique(
          jQuery.merge(this.get(), typeof selector === "string" ? jQuery(selector) : jQuery.makeArray(selector)),
        ),
      );
    },
    ...
    var Sizzle = function (selector, context, results, seed) {
      ...
      if (parts.length > 1 && origPOS.exec(selector)) {
        ...
        var ret = seed
          ...
          : Sizzle.find(
              parts.pop(),
              parts.length === 1 && context.parentNode ? context.parentNode : context,
              isXML(context),
            );
            ...
            if (events[type]) {
              ...
              if (!ret) {
                if (
                  ...
                  jQuery.event.special[type].teardown.call(elem, namespaces) === false
                ) {
